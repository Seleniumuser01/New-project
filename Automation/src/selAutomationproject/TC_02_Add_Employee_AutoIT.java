...
public class TC_02_Add_Employee_AutoIT {
...
if(A.getText().equals("Last Name Empty!"))
{
	...
	A.accept();
	//Enter last name
	driver.findElement(By.name("txtEmpLastName")).sendKeys(sLastName);
}
//Click on save
objSave.click();
...
/*//Way 1://Integrate using Robot class(Abstract Window Toolkit)
//Create object for robot class
Robot rt=new Robot();
//Click on photo file
WebElement objBrowse=driver.findElement(By.name("photofile"));
objBrowse.click();
StringSelection ss=new StringSelection("D:\\Soundarya_automation\\Yellow color.jpg");
//Set image path to deafualt window
...
objBrowse.click();
Thread.sleep(5000);
Runtime.getRuntime().exec("D:\\Soundarya_automation\\Popupupload.exe");
...
if(strEmpName_Sibling.equals(sFirstName+" "+sLastName))
{
