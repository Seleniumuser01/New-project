...
public class TC_10_VTigerCRM_DeleteContact {
...
WebElement objSearchfor12=driver.findElement(By.name("search_text"));
	...
	driver.findElement(By.xpath("//table[@class='lvt small']/tbody/tr[3]/td[1]")).click();
	//click on del button
driver.findElement(By.xpath("//table[@class='lvt small']/tbody/tr[3]/td[10]/a[2]")).click();
...
if(wait.until(ExpectedConditions.textToBePresentInElementLocated(By.xpath
		  ("//*[@id=\"massdelete\"]/table/tbody/tr[1]/td/div/table/tbody/tr[3]/td/div/table/tbody/tr[1]/td[2]/span"),"No Contact Found !")))
{
