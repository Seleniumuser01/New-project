...
public class TC_12_VtigerCRM_EditOpportunitiesInfo 
{
...
//Step 4:Don’t Select the record in the grid and click on Mass Edit button
	  ...
	  Thread.sleep(2000);
		//  Step 6:Click on cancel button in the Mass Edit - Records Fields page  
	      //   Verify Opportunity module page must be displayed
	  ...
	  if(wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("/html/body/table[3]/tbody/tr[2]/td[1]/a"))).isDisplayed())
	  		{
	  	System.out.println("opportunity module page is displayed");
	  		}
	  else
	  {
	  System.out.println("opportunity module page is not displayed");		
	  }  
...
driver.findElement(By.xpath("//table[@class='lvt small']/tbody/tr[3]/td[9]/a[1]")).click();
Thread.sleep(2000);
//Create webelements for opportunity name
String strNewOpponame="EY";
WebElement objOppoNameEdited=driver.findElement(By.name("potentialname"));
//Enter new values to Opportunity name
objOppoNameEdited.sendKeys(Keys.chord(Keys.CONTROL,"a"));
objOppoNameEdited.sendKeys(Keys.DELETE);
objOppoNameEdited.sendKeys(strNewOpponame);
//Click on save
...
driver.findElement(By.name("search_text")).sendKeys(strOppNumberNo);
driver.findElement(By.name("submit")).click();
System.out.println("Record is displayed after edit");
String strEditedNewrecordOppo=driver.findElement(By.xpath("//table[@class='lvt small']/tbody/tr[3]/td[3]/a")).getText();
System.out.println(strEditedNewrecordOppo);
//Verification step
if(strEditedNewrecordOppo.equals(strNewOpponame))
{
	System.out.println("Record is displayed after edit");
}
else
