...
public class TC_14_VTiger_CreateProductsInfo 
{
	public static void main(String[] args) throws Exception
	{
		...
		//Click on the products module link
		wait.until(ExpectedConditions.presenceOfElementLocated
					(By.xpath("//table[@class='hdrTabBg']/tbody/tr/td[2]/table/tbody/tr/td[12]/a"))).click();
		//Verify products module page must be displayed
		if(wait.until(ExpectedConditions.presenceOfElementLocated
				(By.xpath("//table[@class='small']/tbody/tr[2]/td/a"))).isDisplayed())	
			{
			System.out.println(" Products module page is displayed");
			}		
		else
		{
			System.out.println(" Products module page not displayed");
		}	
		...
		if(wait.until(ExpectedConditions.textToBePresentInElementLocated
					(By.xpath("/html/body/table[4]/tbody/tr/td[2]/form/div/span"),"Creating New Product")))
		{
			System.out.println("Creating New Product page is displayed");
		}
		else
		{
			System.out.println("Creating New Product page is not displayed");
		}
		//Create Strings for Last name and Company
		String strprodname="TestLname";
		WebElement objProd=driver.findElement(By.name("productname"));
		driver.findElement(By.xpath
				("/html/body/table[4]/tbody/tr/td[2]/form/div/table/tbody/tr[2]/td/table/tbody/tr/td/table/tbody/tr[2]/td/table/tbody/tr[1]/td/div/input[1]")).click();
		//Verify the last name empty popup message is displayed
		Alert Alert1=wait.until(ExpectedConditions.alertIsPresent());
		if(Alert1.getText().equals("Product Name cannot be empty"))
		{
			System.out.println("Product Name cannot be empty message is displayed");
			Alert1.accept();
		}
		else
		{
			System.out.println("Product Name cannot be empty message is not displayed");
		}
		//Enter value to product name
		Thread.sleep(2000);
		objProd.sendKeys(strprodname);
driver.findElement(By.xpath
("/html/body/table[4]/tbody/tr/td[2]/form/div/table/tbody/tr[2]/td/table/tbody/tr/td/table/tbody/tr[2]/td/table/tbody/tr[1]/td/div/input[1]")).click();
	System.out.println("Record is created");
	//Get the newly created product no
	String strprodno=driver.findElement(By.xpath("//*[@id=\"tblProductInformation\"]/table/tbody/tr[1]/td[4]")).getText();
		System.out.println(strprodno);
//>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>
		//Verify the  Organization Information page must be displayed
		String strprodInfo=driver.findElement
		(By.xpath("/html/body/table[3]/tbody/tr[1]/td/table[2]/tbody/tr/td[2]/div/table[1]/tbody/tr/td/span[1]")).getText();
		System.out.println(strprodInfo);
		if(strprodInfo.equals("["+strprodno+" ] "+strprodname+" - Product Information"))
				{
		...
		{
		System.out.println("products module page is not displayed");		
		}
		Thread.sleep(2000);
		...
		objSearchfor.sendKeys(strprodno);
		//Click on search  now
		objSearchnow.click();
		Thread.sleep(2000);

		//Store the organizaton name newly created in a string FROM THE  organizations MODULE PAGE
		String objprodlistedname=driver.findElement(By.xpath("//table[@class='lvt small']/tbody/tr[3]/td[3]/a")).getText();
		System.out.println(objprodlistedname);
		if(strprodname.equals(objprodlistedname))
		{
