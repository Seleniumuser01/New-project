...
public class TC_21_VTiger_DeleteTrTickets {
	...
	WebElement objSearchfor12=driver.findElement(By.name("search_text"));
		...
		objSearchfor12.sendKeys(strtickno);
	...
	if(wait.until(ExpectedConditions.textToBePresentInElementLocated(By.xpath
			  ("//*[@id=\"massdelete\"]/table/tbody/tr[1]/td/div/table/tbody/tr[3]/td/div/table/tbody/tr[1]/td[2]/span"),"No Ticket Found !")))
	{
