...
public class TC_23_VTigerCRM_EditDocument 
{
...
WebElement editbtn=driver.findElement(By.xpath("//table[@class='lvtBg']/tbody/tr/td/table/tbody/tr/td/div/table/tbody/tr[2]/td/div/table/tbody/tr[3]/td[9]/a"));
editbtn.click();
//Edit the company info in the selected record IN THE SELCETD RECORD INFO PAGE
		WebElement objTitle=driver.findElement(By.name("notes_title"));
		...
		String strchgdtitle=driver.findElement(By.xpath("//table[@class='lvtBg']/tbody/tr/td/table/tbody/tr/td/div/table/tbody/tr[2]/td/div/table/tbody/tr[3]/td[3]/a")).getText();
