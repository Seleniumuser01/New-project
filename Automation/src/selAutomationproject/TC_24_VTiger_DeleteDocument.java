...
public class TC_24_VTiger_DeleteDocument 
{
...
//Step 4:Don’t Select the record in the grid and click on Delete button
		WebElement objDeleteBtn=driver.findElement
				(By.xpath("//*[@id=\"massdelete\"]/table/tbody/tr/td/table/tbody/tr/td/table/tbody/tr/td[1]/table/tbody/tr/td[1]/input"));
		objDeleteBtn.click();
		Thread.sleep(5000);
	...
	//Check the record in the grid and Click on Delete button
	driver.findElement(By.xpath("//table[@class='lvtBg']/tbody/tr/td/table/tbody/tr/td/div/table/tbody/tr[2]/td/div/table/tbody/tr[3]/td[1]")).click();
	...
	String strAlert=Alert3.getText();
	...
	WebElement objSearchfor12=driver.findElement(By.name("search_text"));
		...
		objSearchfor12.sendKeys(docnumber);
		objSearchnow12.click();
		Thread.sleep(2000);
		//click on the checkbox
		driver.findElement(By.xpath("//table[@class='lvtBg']/tbody/tr/td/table/tbody/tr/td/div/table/tbody/tr[2]/td/div/table/tbody/tr[3]/td[1]")).click();
		//click on del button
	driver.findElement(By.xpath("//table[@class='lvtBg']/tbody/tr/td/table/tbody/tr/td/div/table/tbody/tr[2]/td/div/table/tbody/tr[3]/td[9]/a[2]")).click();
	Alert Alert4=wait.until(ExpectedConditions.alertIsPresent());
	if(Alert4.getText().equals("Are You Sure You want to Delete?")) 
	{
		  System.out.println("Message is displayed");
		  Alert4.accept();
	}
	...
	("//*[@id=\"FileList_1\"]/table/tbody/tr[3]/td/div/table/tbody/tr[1]/td[2]/span"),"No Document Found !")))
	{
